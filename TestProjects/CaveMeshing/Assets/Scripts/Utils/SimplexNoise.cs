...
public static class SimplexNoise
{
    ...
    private static readonly double F2 = 0.5 * (Mathf.Sqrt(3f) - 1.0);
    private static readonly double G2 = (3.0 - Mathf.Sqrt(3f)) / 6.0;
    private static readonly double F3 = 1.0 / 3.0;
    private static readonly double G3 = 1.0 / 6.0;
    private static readonly double F4 = (Mathf.Sqrt(5f) - 1.0) / 4.0;
    private static readonly double G4 = (5.0 - Mathf.Sqrt(5f)) / 20.0;
